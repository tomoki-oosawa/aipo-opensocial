...
public interface OAuth2Store {
   ...
   * {@link OAuth2Store.getOAuth2CallbackState}, the store will return the
   * {@link OAuth2Accessor} if it exists in storage but will not create a new
   * one.
   *
   * @param state
   ...
   */
  OAuth2Accessor getOAuth2Accessor(String appId, String gadgetUri,
      String serviceName, String user, String scope) throws GadgetException;
   ...
   */
  OAuth2Token getToken(String appId, String gadgetUri, String serviceName,
      String user, String scope, OAuth2Token.Type type) throws GadgetException;
  ...
  /**
   * Clears all currently cached {@link OAuth2Token}s. Does not remove them from
   * persistence.
   */
  void clearTokenCache() throws GadgetException;

  /**
   * Clears all currently cache {@link OAuth2Client}s. Does not remove the from
   * persistence.
   */
