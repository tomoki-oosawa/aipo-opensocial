 ...
 *
 */
public class OAuth2CallbackStateToken extends AbstractSecurityToken implements
    Serializable {
  ...
  protected AbstractSecurityToken loadFromMap(final Map<String, String> map) {
    ...
    final String i = map.get(AbstractSecurityToken.Keys.APP_ID.getKey());
    if (i != null) {
      this.setAppId(i);
    }
  ...
  public Map<String, String> toMap() {
    ...
    final String i = this.getAppId();
    if (i != null) {
      map.put(AbstractSecurityToken.Keys.APP_ID.getKey(), i);
    }
   ...
   */
  @Override
  public OAuth2CallbackStateToken setAppId(final String appId) {
    this.appId = appId;
    return this;
  }
}
