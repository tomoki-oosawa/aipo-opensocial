...
public interface OAuth2Persister {
  /**
   * Retrieves a client from the persistence layer. Returns <code>null</code> if
   * not found.
   *
   * @param gadgetUri
   * @param serviceName
   * @return the client in the given mapping, must return <code>null</code> if
   *         the client is not found
   * @throws OAuth2PersistenceException
   */
  OAuth2Client findClient(String appId, String gadgetUri, String serviceName)
      throws OAuth2PersistenceException;
   ...
   * @throws OAuth2PersistenceException
   */
  OAuth2Token findToken(String appId, String gadgetUri, String serviceName,
      String user, String scope, OAuth2Token.Type type)
      throws OAuth2PersistenceException;
   ...
   * @throws OAuth2PersistenceException
   */
  boolean removeToken(String gadgetUri, String serviceName, String user,
      String scope, OAuth2Token.Type type) throws OAuth2PersistenceException;
