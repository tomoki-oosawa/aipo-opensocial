...
import com.aipo.orm.model.social.OAuthService;
...
public abstract class _Application extends CayenneDataObject {
    ...
    public static final String OAUTH_SERVICE_PROPERTY = "oauthService";
    ...
    public void addToOauthService(OAuthService obj) {
        addToManyTarget("oauthService", obj, true);
    }
    public void removeFromOauthService(OAuthService obj) {
        removeToManyTarget("oauthService", obj, true);
    }
    @SuppressWarnings("unchecked")
    public List<OAuthService> getOauthService() {
        return (List<OAuthService>)readProperty("oauthService");
    }
