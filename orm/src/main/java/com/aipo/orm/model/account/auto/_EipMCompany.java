...
import com.aipo.orm.model.portlet.EipMMybox;
...
public abstract class _EipMCompany extends CayenneDataObject {
    ...
    public void addToEipMMybox(EipMMybox obj) {
        addToManyTarget("eipMMybox", obj, true);
    }
    public void removeFromEipMMybox(EipMMybox obj) {
        removeToManyTarget("eipMMybox", obj, true);
    }
    @SuppressWarnings("unchecked")
    public List<EipMMybox> getEipMMybox() {
        return (List<EipMMybox>)readProperty("eipMMybox");
    }
