...
public class _EipTExtTimecardSystem extends org.apache.cayenne.CayenneDataObject {
    ...
    public void addToEipTExtTimecardSystemMaps(com.aipo.orm.model.portlet.EipTExtTimecardSystemMap obj) {
        addToManyTarget("eipTExtTimecardSystemMaps", obj, true);
    }
    public void removeFromEipTExtTimecardSystemMaps(com.aipo.orm.model.portlet.EipTExtTimecardSystemMap obj) {
