...
public class AccessControlConstants {
  ...
  /** アクセス権限の機能名（ブログ（他ユーザーへのコメント）） */
  public static final String POERTLET_FEATURE_BLOG_ENTRY_OTHER_REPLY = "blog_entry_other_reply";
  ...
  public static final String POERTLET_FEATURE_TODO_CATEGORY_OTHER = "todo_category_other";
  ...
  public static final String POERTLET_FEATURE_TIMELINE_POST_OTHER = "timeline_post_other";

  /** アクセス権限の機能名（タイムライン（コメント）管理者） */
  public static final String POERTLET_FEATURE_TIMELINE_COMMENT = "timeline_comment";
