...
public class OAuthServlet {
  ...
  public static void handleException(HttpServletResponse response, Exception e,
      String realm, boolean sendBody) throws IOException, ServletException {
    if (e instanceof OAuthProblemException) {
      OAuthProblemException problem = (OAuthProblemException) e;
      Object httpCode =
        problem.getParameters().get(OAuthProblemException.HTTP_STATUS_CODE);
      if (httpCode == null) {
      ...
      OAuthMessage message =
        new OAuthMessage(null, null, problem.getParameters().entrySet());
  ...
  public static void sendForm(HttpServletResponse response,
    ...
    response.setContentType(OAuth.FORM_ENCODED + ";charset=" + OAuth.ENCODING);
